        ...
        <?php if (!empty($models)): ?>
            <?php foreach ($models as $model): ?>
                ...
                <div class="box" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="content">
                        <h3><?=$model['name_'.Yii::$app->language];?></h3>
                        <p><?=$model->tours_category_number?>ta tourni ko'rish</p>
                        <a  href="<?=\yii\helpers\Url::to(['category/view', 'id'=>$model->id])?>" class="btn">read more <i class="fas fa-angle-right"></i></a>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php endif;?>
